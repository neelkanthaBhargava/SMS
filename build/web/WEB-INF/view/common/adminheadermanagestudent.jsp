            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="manageStudent.htm"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                        </li>
                        <li>
                            <%--<spring:url value="/resources/studentpages/charts.html" var="mainCss6" />--%>
                            <!--<spring:url value="#" var="mainCss6" />-->
                            <a href="confirmStudentRegistration.htm"><i class="fa fa-fw fa-thumbs-up"></i>Student Registration</a>
                        </li>
                        <li>
                            <%--<spring:url value="/resources/studentpages/bootstrap-grid.html" var="mainCss10" />--%>
                            <!--<spring:url value="#" var="mainCss10" />-->
                            <a href="updateStudentsGrades.htm"><i class="fa fa-fw fa-bar-chart"></i>Update Student's Grades</a>
                        </li>
                        <li>
                            <spring:url value="#" var="mainCss7" />
                            <%--<spring:url value="/resources/studentpages/tables.html" var="mainCss7" />--%>
                            <a href="#"><i class="fa fa-minus"></i> Remove Faculty</a>
                        </li>
<!--                        <li>
