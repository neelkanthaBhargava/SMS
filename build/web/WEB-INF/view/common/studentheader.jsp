    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="studentLoginSuccess.htm">Student Portal</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="viewStudentProfile.htm"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-life-saver"></i> Help</a>
                        </li>
                        <li>
                            <a href="changeStudentPassword.htm"><i class="fa fa-fw fa-gear"></i> Password</a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="studentLogout.htm"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="studentLoginSuccess.htm"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-bar-chart"></i> Grades <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="fetchResultOfSem.htm?semester=1">Semester 1</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=2">Semester 2</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=3">Semester 3</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=4">Semester 4</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=5">Semester 5</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=6">Semester 6</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=7">Semester 7</a>
                            </li>
                            <li>
                                <a href="fetchResultOfSem.htm?semester=8">Semester 8</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <%--<spring:url value="/resources/studentpages/bootstrap-grid.html" var="mainCss10" />--%>
                    <spring:url value="addAndDrop.htm" var="mainCss10" />
                    <a href="${mainCss10}"><i class="fa fa-fw fa-wrench"></i>Add/Drop Courses</a>
                    </li>
                    <li>
                        <!--<spring:url value="#" var="mainCss7" />-->
                        <%--<spring:url value="/resources/studentpages/tables.html" var="mainCss7" />--%>
                        <a href="#"><i class="fa fa-bell"></i> Notification & Alerts</a>
                    </li>
                    <li>
