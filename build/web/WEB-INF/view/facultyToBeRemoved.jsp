...
<f:form action="removeThisFaculty.htm?faculty_id=${faculty.getFaculty_id()}" commandName="faculty">
    <table>
        <tr>
        ...
        <tr><td colspan="2"><button type="submit" class="btn-success">Remove</button></td></tr>
    </table>
</f:form>
