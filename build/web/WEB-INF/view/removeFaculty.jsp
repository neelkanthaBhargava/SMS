...
<div class="col-lg-12">
    <h1 class="page-header">
        <font style="text-transform: capitalize;">Remove faculty information</font>
    </h1>
    <ol class="breadcrumb">
        <li class="active">
...
<f:form commandName="faculty" action="facultyToBeRemovedById.htm">
    <table class="table-bordered">
        ...
        <tr>
            <f:form commandName="faculty" action="listFacultyToBeRemovedByName.htm">
